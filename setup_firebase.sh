...
then
    projectEnv="dev"
    flutterfire configure --project=$projectName --ios-bundle-id="friends.dev" --android-package-name="friends.dev" --android-app-id="friends.dev" --platforms="android,ios" --yes
else
